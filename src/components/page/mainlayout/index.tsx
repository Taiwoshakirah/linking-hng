    ...
    <div className="py-[7rem] px-[5rem] lg:block hidden">
      <div className="h-[631px] w-[307px] relative">
        ...
        <div>
          ...
          {firstName && lastName && (
            <div className="text-center absolute top-[12rem] left-0 right-0 flex justify-center">
          ...
          {email && (
            <div className="text-center absolute top-[14rem] left-0 right-0 flex justify-center">
